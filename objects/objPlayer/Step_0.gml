...
Por isso vamos impedir que ele saiu usando novamento o place_meeting()
Descrição no objBola.step linha 55
ou seja, se colocarmos andarmos e batemos em uma parede iremos bloquear
*/
//Para ambos os lados 
